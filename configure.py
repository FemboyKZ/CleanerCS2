...
parser.options.add_argument(
    ...
    default="../metamod-source/hl2sdk-manifests",
...
parser.options.add_argument(
    ...
    dest="re2_root",
    default=None,
    help="Root of a static re2 install (contains include/ and lib/libre2.a). "
    "Falls back to $RE2_ROOT then /opt/re2.",
)
parser.options.add_argument(
    "--enable-debug",
    action="store_const",
...
parser.options.add_argument(
    ...
    'comma-delimited list of engine names (default: "cs2")',
)
parser.options.add_argument(
    "--targets",
    type=str,
